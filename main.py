...
if len(sys.argv) < 2 :
    print ("Usage: "+sys.argv[0]+" Config.cfg missing")
    sys.exit(1)
...
# identifiers of moraines assigned to each dataset
...
t3 = time()
print("\ntotal duration (in min) :", (t3-t0)/60)
print("\ndataset creation time (in min) :", (t1-t0)/60)
print("\ntraining time (in min) :", (t2-t1)/60)
print("\ncreate map duration (in min) :", (t3-t2)/60)
