...
class Param ():
    ...
    def create_stack_info(self):
        """
        Creation of a dictionary containing all pre-processing data
        It will be browsed in preprocess_data.py so that at each band,
        the algorithm has the right file name to load it and the right normalization method
        """
